...
export class CookieSettingHelper {
  ...
  constructor(private readonly configService: ConfigService<AllConfigType>) {
    const isProd =
      this.configService.getOrThrow('app.nodeEnv', { infer: true }) === 'prod';
    ...
    this.accessCookieOptions = {
      ...this.baseCookieOptions,
      maxAge: parse(
        this.configService.getOrThrow('token.accessTokenLifeTime', {
          infer: true,
        }),
      ),
    };
    ...
    this.refreshCookieOptions = {
      ...this.baseCookieOptions,
      maxAge: parse(
        this.configService.getOrThrow('token.refreshTokenLifeTime', {
          infer: true,
        }),
      ),
    };
